        ...
        <div className="space-y-5">
          <div className="rounded-md border bg-background p-3">
            ...
            <div className="mt-3 flex gap-2">
              <Input disabled placeholder="User lookup endpoint unavailable" aria-label="Search registered users" />
              <Button type="button" disabled>
                Add
              </Button>
            </div>
            <p className="mt-2 text-xs text-muted-foreground">
              A safe registered-user lookup endpoint is required before adding members from the frontend.
            </p>
          </div>
