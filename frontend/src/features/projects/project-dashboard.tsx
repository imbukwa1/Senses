...
import {
  ...
  useProjectMilestoneFinanceQuery,
...
function FinanceMilestonesSection({ canEdit, projectId }: { canEdit: boolean; projectId: string }) {
  ...
  if (query.isError) return <ErrorState title="Milestone finance could not be loaded" message={dashboardErrorMessage(query.error)} />;
